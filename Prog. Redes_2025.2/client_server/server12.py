...
while True:
    ...
    try:
        ...
        # LISTAGEM
            ...
            print(f" Tamanho do JSON: {len(json_bytes)} bytes.")
        ...
        # UPLOAD
            ...
            print(f" Comando de upload recebido. Arquivo alvo: '{nome_arquivo}'")
            ...
            if bytes_recebidos == tam_arquivo:
                print(f" Upload de '{nome_arquivo}' completo. Total de {bytes_recebidos} bytes salvos.")
                con.send(b'\x01')
            else:
                con.send(b'\x00')
